...
aut aut aut maxime quia temporibus ut omnis`}],Nc=[{id:1,name:"Leanne Graham",username:"Bret",email:"Sincere@april.biz"},{id:2,name:"Ervin Howell",username:"Antonette",email:"Shanna@melissa.tv"},{id:3,name:"Clementine Bauch",username:"Samantha",email:"Nathan@yesenia.net"},{id:4,name:"Patricia Lebsack",username:"Karianne",email:"Julianne.OConner@kory.org"},{id:5,name:"Chelsey Dietrich",username:"Kamren",email:"Lucio_Hettinger@annie.ca"},{id:6,name:"Mrs. Dennis Schulist",username:"Leopoldo_Corkery",email:"Karley_Dach@jasper.info"},{id:7,name:"Kurtis Weissnat",username:"Elwyn.Skiles",email:"Telly.Hoeger@billy.biz"},{id:8,name:"Nicholas Runolfsdottir V",username:"Maxime_Nienow",email:"Sherwood@rosamond.me"},{id:9,name:"Glenna Reichert",username:"Delphine",email:"Chaim_McDermott@dana.io"},{id:10,name:"Clementina DuBuque",username:"Moriah.Stanton",email:"Rey.Padberg@karina.biz"}],Pc=({comment:e})=>V.jsxs("div",{className:"CommentInfo",children:[V.jsxs("div",{className:"CommentInfo__title",children:[V.jsx("strong",{className:"CommentInfo__name",children:e.name})," by ",V.jsx("a",{className:"CommentInfo__email",href:`mailto:${e.email}`,children:e.email})]}),V.jsx("div",{className:"CommentInfo__body",children:e.body})]}),Lc=({comments:e})=>V.jsx("div",{className:"CommentList",children:e.map(t=>V.jsx(Pc,{comment:t},t.id))}),Tc=({user:e})=>V.jsx("a",{className:"UserInfo",href:`mailto:${e.email}`,children:e.name}),Mc=({post:e})=>V.jsxs("div",{className:"PostInfo",children:[V.jsxs("div",{className:"PostInfo__header",children:[V.jsx("h3",{className:"PostInfo__title",children:e.title}),V.jsxs("p",{children:[" Posted by  ",V.jsx(Tc,{user:e.user})]})]}),V.jsx("p",{className:"PostInfo__body",children:e.body}),V.jsx(Lc,{comments:e.comments})]}),Rc=({posts:e})=>V.jsx("div",{className:"PostList",children:e.map(t=>V.jsx(Mc,{post:t},t.id))}),Dc=Cc.map(e=>({...e,user:Nc.find(t=>t.id===e.userId),comments:zc.filter(t=>t.postId===e.id)})),jc=()=>V.jsxs("section",{className:"App",children:[V.jsx("h1",{className:"App__title",children:"Static list of posts"}),V.jsx(Rc,{posts:Dc})]});em(document.getElementById("root")).render(V.jsx(jc,{}));
